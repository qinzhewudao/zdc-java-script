...
public class TimeWheelService {
    ...
    public TimeWheelService(int corePoolSize) {
        this(new ThreadPoolExecutor(corePoolSize, corePoolSize,
                0L, TimeUnit.MILLISECONDS,
                new LinkedBlockingQueue<>(10000)));
    }

    public TimeWheelService(ThreadPoolExecutor threadPoolExecutor) {
        executorService = threadPoolExecutor;
        TimeWheelThread thread = new TimeWheelThread();
        thread.start();
    }
